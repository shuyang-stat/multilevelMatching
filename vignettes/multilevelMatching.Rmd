...
Here's four ways of estimating this:
...
You could also use proportional odds logistic regression:

```{r}
match5 <- multilevelGPSMatch(Y,W,X,Trimming=TRUE,GPSM="ordinallogisticReg")
match5$results
```
